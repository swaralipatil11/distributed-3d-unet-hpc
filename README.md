...
- **Downsampled Boundary Shell Mesh Generation**: Prevents UI lag in WebGL canvases by identifying boundary voxels (active voxels containing background neighbors in a 6-neighborhood), reducing rendering load from over 100,000 to under 8,000 points.
